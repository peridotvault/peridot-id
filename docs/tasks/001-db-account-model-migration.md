# 001 — DB: Account Model Migration
...
- PRD_v5 §2 (core model); PRD_v4 §15 (database model), §9 (server-side allowed/forbidden
  storage), §28 (Wallet: deterministically resolvable)
