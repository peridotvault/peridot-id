...
// three.js rides an async chunk so CTA copy paints with zero GL tax.
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          >
            One identity for the whole ecosystem
          </motion.h2>
          ...
          >
            Unify sign-in, sessions, and profiles on one platform — and give
            your players a single identity from day one.
          </motion.p>
          ...
          >
            ...
            <CutButton variant="outline" href="/docs/sdk">
              Explore the SDK
            </CutButton>
          </motion.div>
        </motion.div>
