/// <reference lib="dom" />
// Exact port of apps/web/components/landing/ascii-ridges.tsx (same shaders,
// same flow math). Web-only build: Metro resolves this file on web and
// AsciiRidges.native.tsx everywhere else, so three/fiber never touch native.
...
export const AsciiRidges: React.FC<AsciiRidgesProps> = ({
  characters = " .:-+*=%@#",
  color = "#87ee83",
  invert = false,
  elementSize = 10.0,
