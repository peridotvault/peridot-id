...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Players", icon: Radar },
  { label: "Sessions", icon: MonitorSmartphone },
  { label: "Apps", icon: Cloud },
...
const ALERTS: Alert[] = [
  ...
  },
  {
    ...
    title: "Session revoked after report",
    meta: "game-server-04",
    time: "14m",
    status: "Contained",
  },
      ...
      <div className="border-t border-border/60 p-3">
        <div className="flex items-center gap-2 rounded-md border border-border/60 bg-background px-2.5 py-2">
          ...
          <span className="flex flex-col leading-tight">
            <span className="text-[11px] font-medium">All sessions healthy</span>
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-[11px] text-muted-foreground">
            Sessions vs. successful sign-ins
          </p>
        </div>
